...
Public Class CR_listadocliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.CR_listadocliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_listadocliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_listadocliente = New CR_listadocliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
