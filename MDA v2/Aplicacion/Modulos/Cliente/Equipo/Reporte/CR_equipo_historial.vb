...
Public Class CR_equipo_historial
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CR_equipo_historial.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.CR_equipo_historial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_equipo_historial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_equipo_historial = New CR_equipo_historial()
        rpt.Site = Me.Site
        Return rpt
    End Function
