...
Public Class CR_equipo_historial_b
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CR_equipo_historial_b.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.CR_equipo_historial_b.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_equipo_historial_b
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_equipo_historial_b = New CR_equipo_historial_b()
        rpt.Site = Me.Site
        Return rpt
    End Function
