...
Public Class CR_equipo_info
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.CR_equipo_info.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_equipo_info
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_equipo_info = New CR_equipo_info()
        rpt.Site = Me.Site
        Return rpt
    End Function
