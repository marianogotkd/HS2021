...
Public Class CR_mantenimiento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.CR_mantenimiento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_mantenimiento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_mantenimiento = New CR_mantenimiento()
        rpt.Site = Me.Site
        Return rpt
    End Function
