<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Pago.aspx.vb" Inherits="Presentacion.Pago" %>
...
<div class="card">
            <div class="card-body">
                    <div class="form-group">
                            <div class="row justify-content-center">
                                    <div class="col-md-8">
                                        <label for="Label_cliente_id">OPCION 3: CARGA de PAGOS.</label> 
                                    </div>
                                    <%--<div class="col-md-4">
                                    </div>--%>
                            </div>
