                        ...
                        <div class="form-group">       
                                <div class="row justify-content-center">
                                        <div class="col-md-2">
                                                ...
                                                <asp:TextBox ID="Txt_diasacobrar" runat="server" class="form-control" placeholder="0" CausesValidation="True" validationgroup="check_2" xmlns:asp="#unknown2" MaxLength="3" onkeydown="tecla_op(event);" onkeypress="return justNumbers(event);"></asp:TextBox>
