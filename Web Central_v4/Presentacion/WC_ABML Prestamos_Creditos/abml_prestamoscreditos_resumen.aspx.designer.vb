...
Partial Public Class abml_prestamoscreditos_resumen
    ...
    '''<summary>
    '''Control btn_ELIMINAR_close.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents btn_ELIMINAR_close As Global.System.Web.UI.HtmlControls.HtmlButton

    '''<summary>
    '''Control btn_ok_elimnar.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents btn_ok_elimnar As Global.System.Web.UI.HtmlControls.HtmlButton

    '''<summary>
    '''Control btn_close_error_busqueda.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents btn_close_error_busqueda As Global.System.Web.UI.HtmlControls.HtmlButton

    '''<summary>
    '''Control btn_ok_error_busqueda.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents btn_ok_error_busqueda As Global.System.Web.UI.HtmlControls.HtmlButton
End Class
