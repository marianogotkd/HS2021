                ...
                <div class="form-group">
                        <div class="row">
                                ...
                                <asp:Label ID="Label14" runat="server" Text="RECORRIDO 2" ForeColor="#6666FF"></asp:Label>
                                    ...
                                    &nbsp;<asp:TextBox ID="TextBox1" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label16" runat="server" Text="2B - ZONA 12:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox2" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label17" runat="server" Text="2C - ZONA 13:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox3" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label18" runat="server" Text="2D - ZONA 14:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox4" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label19" runat="server" Text="2E - ZONA 15:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox5" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label20" runat="server" Text="2F - ZONA 16:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox6" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label21" runat="server" Text="2G - ZONA 17:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox7" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label22" runat="server" Text="2H - ZONA 18:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox8" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label23" runat="server" Text="2I - ZONA 19:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox9" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label24" runat="server" Text="2J - ZONA 20:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox10" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                </div>
                                ...
                                <asp:Label ID="Label25" runat="server" Text="RECORRIDO 3" ForeColor="#6666FF"></asp:Label>
                                    ...
                                    &nbsp;<asp:TextBox ID="TextBox11" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label27" runat="server" Text="3B - ZONA 22:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox12" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label28" runat="server" Text="3C - ZONA 23:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox13" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label29" runat="server" Text="3D - ZONA 24:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox14" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label30" runat="server" Text="3E - ZONA 25:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox15" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label31" runat="server" Text="3F - ZONA 26:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox16" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label32" runat="server" Text="3G - ZONA 27:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox17" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label33" runat="server" Text="3H - ZONA 28:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox18" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label34" runat="server" Text="3I - ZONA 29:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox19" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label35" runat="server" Text="3J - ZONA 30:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox20" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                </div>
                                ...
                                <asp:Label ID="Label36" runat="server" Text="RECORRIDO 4" Font-Bold="False" 
                                    ...
                                    &nbsp;<asp:TextBox ID="TextBox21" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label38" runat="server" Text="4B - ZONA 32:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox22" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label39" runat="server" Text="4C - ZONA 33:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox23" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label40" runat="server" Text="4D - ZONA 34:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox24" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label41" runat="server" Text="4E - ZONA 35:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox25" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label42" runat="server" Text="4F - ZONA 36:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox26" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label43" runat="server" Text="4G - ZONA 37:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox27" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label44" runat="server" Text="4H - ZONA 38:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox28" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label45" runat="server" Text="4I - ZONA 39:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox29" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="Label46" runat="server" Text="4J - ZONA 40:" Width="100px"></asp:Label>
                                    &nbsp;<asp:TextBox ID="TextBox30" runat="server" Text="0" MaxLength="1" Width="30px" onkeydown="tecla_op(event);" onkeypress="return solo_ceroyuno_valitation(event);"></asp:TextBox>
                                    <br />
                                </div>
                        </div>
                </div>
