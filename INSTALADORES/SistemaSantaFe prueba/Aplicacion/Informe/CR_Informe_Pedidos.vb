...
Public Class CR_Informe_Pedidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.CR_Informe_Pedidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Informe_Pedidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Informe_Pedidos = New CR_Informe_Pedidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
