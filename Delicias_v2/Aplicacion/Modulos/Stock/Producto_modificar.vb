...
#End Region
    ...
    Private Sub DG_Producto_CellFormatting(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles DG_Producto.CellFormatting
        'aqui validamos las filas, ponemos en rojo las que tengan stock bajo.
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        If DG_Producto.Rows.Count <> 0 Then
            Dim prod_codinterno As Integer = CInt(DG_Producto.CurrentRow.Cells("prod_codinterno").Value)
            Ajuste_precios.Close()
            Ajuste_precios.prod_codinterno = prod_codinterno
            Ajuste_precios.Show()
            Me.Hide()
        End If
