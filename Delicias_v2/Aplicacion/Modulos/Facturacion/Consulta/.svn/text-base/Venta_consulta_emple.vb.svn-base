Public Class Venta_consulta_emple
    ...
    Private Sub Venta_Consulta_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        obtener_usuarios()
        tabla_filtrada()
        'seleccionar el usuario empleado
    ...
    Private Sub BUSCAR_RANGO()
        ...
        Dim cont As Integer = Tabla_suma.Rows.Count
        Dim cont_ds_usuarios As Integer = ds_usuarios.Tables(0).Rows.Count
        While x < ds_usuarios.Tables(0).Rows.Count 'Tabla_suma.Rows.Count
    ...
    Public Sub BO_producto_modificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BO_producto_modificar.Click
        ...
        If Me.DataGridView1.CurrentRow IsNot Nothing Then
            ...
            If detalles <> "" Then
                DS_detalles = DAVentas.VentaProducto_consulta(DataGridView1.CurrentRow.Cells("USUidDataGridViewTextBoxColumn").Value, DataGridView1.CurrentRow.Cells("VentaprodfechaDataGridViewTextBoxColumn").Value)
