...
#Region "METODOS Y EVENTOS DE LA GRILLA DE PRODUCTOS"
            ...
            Case "Minorista"
                ...
                While i < VentaGestion_DS_PROD.Tables(1).Rows.Count 'la tabla 1 es para los prod comunes, no para los de la lista regular
                    ...
                    If cod_ingresado = cod_interno Or CStr(cod_ingresado) = cod_barra Then
                        ...
                        precio_editable = VentaGestion_DS_PROD.Tables(1).Rows(i).Item("prod_precio_editable").ToString
    ...
    Private Sub DataGridView1_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGridView1.SelectionChanged
        ...
        '    If listo = "pasar a precio unitario" Then
        '        DataGridView1.CurrentCell = DataGridView1(7, fila_mover)
        '    End If
        ...
        '        'si hay una fila abajo me muevo si no, NO.
        '        If (fila_mover + 1) < DataGridView1.Rows.Count Then
    ...
    Private Sub DataGridView1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles DataGridView1.KeyDown
        ...
        If DataGridView1.CurrentCell.ColumnIndex = 3 Then 'es descripcion
            If e.KeyCode = Keys.Enter Then
                e.SuppressKeyPress = True
                SendKeys.Send("{TAB}")
            End If
        ...
        If DataGridView1.CurrentCell.ColumnIndex = 7 Then 'columna precio unitario, se hacen varios TAB hasta pasar a la siguiente fila
            If e.KeyCode = Keys.Enter Then
                e.SuppressKeyPress = True
                SendKeys.Send("{TAB}")
                SendKeys.Send("{TAB}")
        ...
        If DataGridView1.CurrentCell.ColumnIndex = 8 Then 'es subtotal
            If e.KeyCode = Keys.Enter Then
                e.SuppressKeyPress = True
                SendKeys.Send("{TAB}")
            End If
        ...
        If DataGridView1.CurrentCell.ColumnIndex = 10 Then 'es columna quitar check
            If e.KeyCode = Keys.Enter Then
                e.SuppressKeyPress = True
                SendKeys.Send("{TAB}")
                SendKeys.Send("{TAB}")
        ...
        Select Case DataGridView1.CurrentCell.ColumnIndex
            ...
            Case 5
                If DataGridView1.CurrentCell.ColumnIndex = 5 Then 'la columna 5 es Cantidad, la columna 6 es descuento
                    ...
                    Try
                        'ahora me muevo a la fila de al lado
                        Dim fila As Integer = DataGridView1.CurrentRow.Index
                        DataGridView1.CurrentCell = DataGridView1(6, fila) 'se mueve a la columna de descuento
                        editado = "si"
                    Catch ex As Exception
            ...
            Case 6
                If DataGridView1.CurrentCell.ColumnIndex = 6 Then 'la columna 6 es descuento
                    ...
                    calcular_totales()
                    aplicar_iva()
                    listo = "pasar a precio unitario"

                    Try
                        'ahora me muevo a la fila de al lado
                        Dim fila As Integer = DataGridView1.CurrentRow.Index
                        DataGridView1.CurrentCell = DataGridView1(7, fila) 'se mueve a la columna de precio unitario
                        editado = "si"
                    Catch ex As Exception
                ...
                End If
            Case 7
                If DataGridView1.CurrentCell.ColumnIndex = 7 Then 'la columna 7 es precio unitario
                    If DataGridView1.CurrentCell.Value Is DBNull.Value Then
                        DataGridView1.CurrentCell.Value = CDec(0)
                    End If
                    Dim precio As Decimal = 0
                    ...
                    Try 'intentamos movernos a la fila de abajo si es que se puede
                        'ahora me muevo a la fila de al lado
                        Dim fila As Integer = DataGridView1.CurrentRow.Index
                        DataGridView1.CurrentCell = DataGridView1(2, fila + 1) 'se mueve a la columna de cod interno de la fila de abajo si y solo si se puede
                        'editado = "si"
                    Catch ex As Exception
...
#Region "METODOS"
    ...
    Public Sub habilitar_columnas_edicion()
        ...
        While fila < Me.DataGridView1.Rows.Count
            ...
            'Me.DataGridView1.Rows(fila).Cells(8).Style.BackColor = Color.GhostWhite
            'Me.DataGridView1.Rows(fila).Cells(9).Style.BackColor = Color.GhostWhite
                                ...
                                If (deuda <= limite_deuda) Or limite_deuda = 0 Then
                                    DAventa.Remito_productos_modificar(remito_ventaprod_id, CDec(txt_total.Text),
                                                             ...
                                                             CDec(ComboBox_iva.SelectedItem),
                                                              CDec(txt_impuesto_aplicado.Text), venta_tipo_descripcion, 0, vendedor_id, "Pendiente", 0)
                                    'Actualizar Stock
...
#Region "Validacion de grilla - solo numeros en celda"
    Private Sub DataGridView1_EditingControlShowing(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewEditingControlShowingEventArgs) Handles DataGridView1.EditingControlShowing
        ...
        valido_precio_editable(DataGridView1.CurrentRow.Cells("columna_codinterno").Value)
    ...
    Private Sub valido_precio_editable(ByVal cod_ingresado As String)
        'Encontrado = "no"
        Dim i As Integer = 0
        While i < VentaGestion_DS_PROD.Tables(1).Rows.Count
            Dim cod_interno As String = VentaGestion_DS_PROD.Tables(1).Rows(i).Item("prod_codinterno").ToString
    ...
    Private Sub validar_Keypress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        ...
        If CStr(DataGridView1.CurrentRow.Cells("columna_codinterno").Value) = "" And (columna = 5 Or columna = 6 Or columna = 7) Then 'la columna 5 es Cantidad, la columna 6 es descuento, la columna 7 es precio unitario
        ...
        Else
            ...
            Else
                ...
                If columna = 5 Then
                    ...
                    End If
                End If
                If (columna = 6) Or (columna = 7 And precio_editable = "si") Then 'la columna 6 es descuento, que acepta decimales
                    Dim caracter As Char = e.KeyChar
                    '        'referencia a la celda
                    Dim txt As TextBox = CType(sender, TextBox)
                    'aqui pongo el codigo para remplazar el punto por una coma
                ...
                If columna = 7 And precio_editable = "no" Then
                    e.Handled = True 'bloqueo todo ingreso en primera instancia
                End If
