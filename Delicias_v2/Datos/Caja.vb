...
#End Region
    ...
    Public Function Caja_obtener_productos_facturados_X_categoria(ByVal caja_id As Integer) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("Caja_obtener_productos_facturados_X_categoria", dbconn)
        comando.Parameters.Add(New OleDb.OleDbParameter("@caja_id", caja_id))
        comando.CommandType = CommandType.StoredProcedure
