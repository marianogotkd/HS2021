...
Public Class CR_InformeEmpleado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.CR_InformeEmpleado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_InformeEmpleado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_InformeEmpleado = New CR_InformeEmpleado()
        rpt.Site = Me.Site
        Return rpt
    End Function
