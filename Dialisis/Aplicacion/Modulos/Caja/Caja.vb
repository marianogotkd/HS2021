    ...
    Public Sub Caja_Validar()
        ...
        Select Case (SESION_CAJA)
            Case (1)
                ...
                US_administrador.Tool_Medico.DropDownItems("ToolStripMenuItem_servicio_nuevo").Enabled = False 'servicio alta
                US_administrador.Tool_Medico.DropDownItems("ToolStripMenuItem3").Enabled = False
                ...
                US_administrador.Tool_Medico.DropDownItems("ToolStripMenuItem_servicio_nuevo").Enabled = False
            ...
            Case (2)
                ...
                US_administrador.Tool_Medico.DropDownItems("ToolStripMenuItem_servicio_nuevo").Enabled = True 'servicio alta
                US_administrador.Tool_Medico.DropDownItems("ToolStripMenuItem3").Enabled = True
