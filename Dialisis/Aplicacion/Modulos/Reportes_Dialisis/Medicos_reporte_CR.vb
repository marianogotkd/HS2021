...
Public Class Medicos_reporte_CR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.Medicos_reporte_CR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMedicos_reporte_CR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Medicos_reporte_CR = New Medicos_reporte_CR()
        rpt.Site = Me.Site
        Return rpt
    End Function
