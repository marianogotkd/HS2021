...
Public Class trasplante_CR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.trasplante_CR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedtrasplante_CR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As trasplante_CR = New trasplante_CR()
        rpt.Site = Me.Site
        Return rpt
    End Function
