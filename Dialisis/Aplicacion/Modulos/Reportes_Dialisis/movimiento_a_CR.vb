...
Public Class movimiento_a_CR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.movimiento_a_CR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmovimiento_a_CR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As movimiento_a_CR = New movimiento_a_CR()
        rpt.Site = Me.Site
        Return rpt
    End Function
