...
Public Class Consulta_clinica_CR
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Consulta_clinica_CR.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.Consulta_clinica_CR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsulta_clinica_CR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Consulta_clinica_CR = New Consulta_clinica_CR()
        rpt.Site = Me.Site
        Return rpt
    End Function
