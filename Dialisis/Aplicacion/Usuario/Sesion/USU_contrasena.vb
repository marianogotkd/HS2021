Public Class USU_contrasena
    ...
    Private Sub BOT_ingresar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        INGRESAR()
    End Sub

    Private Sub INGRESAR()
        Dim result As DialogResult
        result = MessageBox.Show("¿Desea Cambiar la Contraseña de Usuario?", "Sistema de Gestion.", MessageBoxButtons.OKCancel, MessageBoxIcon.Question)
        If result = DialogResult.OK Then
            ...
            If TX_USU_cont_nue.Text <> "" And TX_USU_cont_rnue.Text <> "" And TX_USU_cont_nue.Text = TX_USU_cont_rnue.Text Then
                ...
                Me.Close()
                MessageBox.Show("La Contraseña a sido cambiada Correctamente.", "Sistema de Gestión.", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Else
                MessageBox.Show("Error, modifique la contraseña nueva.", "Sistema de Gestión.", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub TX_USU_cont_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Verificar()
    End Sub

    Private Sub TX_USU_cont_nue_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Verificar()
    End Sub

    Private Sub TX_USU_cont_rnue_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Verificar()
    End Sub
    ...
    Private Sub BOT_ingresar_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BOT_ingresar.Click
        INGRESAR()
    End Sub
End Class