...
Public Class Proveedor
    ...
    Public Function Producto_x_Sucursal_obtener_todo_proveedor(ByVal Sucursal_id As Integer, ByVal Prov_id As Integer) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("Producto_x_Sucursal_obtener_todo_proveedor", dbconn)
        comando.CommandType = CommandType.StoredProcedure
