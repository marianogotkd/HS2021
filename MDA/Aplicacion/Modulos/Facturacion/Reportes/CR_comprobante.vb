...
Public Class CR_comprobante
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.CR_comprobante.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_comprobante
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_comprobante = New CR_comprobante()
        rpt.Site = Me.Site
        Return rpt
    End Function
