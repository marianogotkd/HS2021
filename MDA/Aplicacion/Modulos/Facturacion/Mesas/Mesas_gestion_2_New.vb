Public Class Mesas_gestion_2_new
    Dim DAventa As New Datos.Venta
    'Dim tooltip1 As New ToolTip

    Public procedencia_turno_new As String = "no" 'cuando diga si es x q tengo q asignar una mesa a un turno, q recien lo hago correr
    Public idclie_procendencia_turno_new As Integer = 0 'cuando tenga otro valor es x q tengo q asignat una mesa
    Public PAGADO_procedencia_turno_new As Decimal = CDec(0)
    Public SALDO_procedencia_turno_new As Decimal = CDec(0)
    Public TURNO_id_procedencia_turno_new As Integer = 0
...
#End Region
    ...
    Public Sub Asignar_mesa_parametros(ByVal sector_nombre As String, ByVal sector_id As Integer, ByVal mesa_nombre As Integer)
        ...
        If procedencia_turno_new = "si" Then
            Mesa_asignar.idclie_procendencia_mesasgestion = idclie_procendencia_turno_new
            Mesa_asignar.procedencia_mesasgestion = "si"
            Mesa_asignar.PAGADO_procedencia_mesasgestion = PAGADO_procedencia_turno_new
            Mesa_asignar.SALDO_procedencia_mesasgestion = SALDO_procedencia_turno_new
            Mesa_asignar.Bloquear_consumidor_selecc_cliente()
            Mesa_asignar.TURNO_id_procedencia_mesasgestion = TURNO_id_procedencia_turno_new

            idclie_procendencia_turno_new = 0
            procedencia_turno_new = "no"
            PAGADO_procedencia_turno_new = CDec(0)
            SALDO_procedencia_turno_new = CDec(0)
        End If
    ...
    Dim validaciones As Mesas


    Public Sub Habilitar_asignacion_pendiente(ByVal Procedencia As String) 'esta se ejecuta o llama desde: MESA_ASIGNAR
        Dim proc = Procedencia
        If proc <> "Mesas_consulta_gestion" Then
            Me.BotonB.BackColor = Color.IndianRed
            Me.ToolTip1.SetToolTip(BotonB, "Mesa ocupada")
        End If
    ...
    Dim BotonB As Button 'lo defino afuera para poder usarlo en Habilitar_asignacion_pendiente
        ...
        If itemMenu Is Nothing = False Then
            ...
            If Owner Is Nothing = False Then
                ...
                If TypeOf Objeto Is Button Then
                    BotonB = Objeto
                    If BotonB.BackColor = Color.ForestGreen Then
                        Call Asignar_mesa_parametros(nombre_sector, Nro_Sector, BotonB.Text)
                    Else
    ...
    Private Sub CargarMesa_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CargarMesa.Click
        ...
        If itemMenu Is Nothing = False Then
            ...
            If Owner Is Nothing = False Then
                ...
                If TypeOf Objeto Is Button Then
                    BotonB = Objeto
                    If BotonB.BackColor = Color.IndianRed Then
                        Call Cargar_mesa_parametros(nombre_sector, Nro_Sector, BotonB.Text)
                    Else
                        If BotonB.BackColor = Color.CadetBlue Then
        ...
        If itemMenu Is Nothing = False Then
            ...
            If Owner Is Nothing = False Then
                ...
                If TypeOf Objeto Is Button Then
                    BotonB = Objeto
                    If BotonB.BackColor = Color.CadetBlue Then
                        Liberar_mesa(BotonB.Text, Nro_Sector)
                        BotonB.BackColor = Color.ForestGreen
                        ToolTip1.SetToolTip(BotonB, "Mesa libre")
...
#Region "FOCO MOUSE MESAS" 'CUANDO PONEMOS EL PUNTERO SOBRE LA MESA...SE ACTUALIZA EL VALOR DE LA VARIABLE MESAM necesaria para el menu contextual
    Dim mesa As String = ""
    Dim mesa_nro As Integer = 0
    Dim Nro_Sector As Integer = 0
...
#End Region
    ...
    Private Sub BO_Agregar_mesa_MouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles BO_Agregar_mesa.MouseClick
