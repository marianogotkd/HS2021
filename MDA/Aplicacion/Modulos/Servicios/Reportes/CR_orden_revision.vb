...
Public Class CR_orden_revision
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.CR_orden_revision.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_orden_revision
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_orden_revision = New CR_orden_revision()
        rpt.Site = Me.Site
        Return rpt
    End Function
