...
#Region "MANTENIMIENTO"
    ...
    Public Function Mantenimiento_obtener_calendario_B(ByVal fecha As DateTime, ByVal Mantenimiento_id As Integer) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("Mantenimiento_obtener_calendario_B", dbconn)
        comando.CommandType = CommandType.StoredProcedure
    ...
    'mantenimiento_realizado_eliminar
    Public Function Mantenimiento_realizado_eliminar(ByVal Mant_realizados_id As Integer) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("Mantenimiento_realizado_eliminar", dbconn)
        comando.CommandType = CommandType.StoredProcedure
...
#Region "CALENDARIO MANTENIMIENTO"
    ...
    Public Function Mantenimiento_iniciales_obtener_todo() As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("Mantenimiento_iniciales_obtener_todo", dbconn)
        comando.CommandType = CommandType.StoredProcedure
