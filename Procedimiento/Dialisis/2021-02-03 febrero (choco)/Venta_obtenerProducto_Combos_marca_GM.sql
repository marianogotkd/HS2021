USE [Dialisis]
GO
/****** Object:  StoredProcedure [dbo].[Venta_obtenerProducto_Combos_marca_GM]    Script Date: 02/04/2021 18:21:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER procedure [dbo].[Venta_obtenerProducto_Combos_marca_GM]---al titulo lo llamé GM x q lo uso en gestion de mercaderia
...
where Producto_x_sucursal.sucursal_id=@sucursal_id and marca.Marca_id=@marca_id  
