USE [Dialisis]
GO
/****** Object:  StoredProcedure [dbo].[TurnoDialisis_consultar_sesion_paciente]    Script Date: 02/25/2021 17:32:30 ******/
SET ANSI_NULLS ON
GO
...
---recupero un solo
--registro que tiene la info de la sesion y ademas la dialisis
select 
