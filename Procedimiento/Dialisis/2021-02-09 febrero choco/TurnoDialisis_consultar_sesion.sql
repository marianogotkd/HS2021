USE [Dialisis]
GO
/****** Object:  StoredProcedure [dbo].[TurnoDialisis_consultar_sesion]    Script Date: 02/09/2021 03:03:21 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER procedure [dbo].[TurnoDialisis_consultar_sesion]
@PAC_id int,
@fecha datetime
...
where Sesiones.PAC_id = @PAC_id and sesiones_fecha = @fecha 
