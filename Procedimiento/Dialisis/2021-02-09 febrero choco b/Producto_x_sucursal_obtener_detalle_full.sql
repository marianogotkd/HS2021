create procedure [dbo].[Producto_x_sucursal_obtener_detalle_full]
----choco: 10-02-2021 me trae toda la info de un producto en una determinada sucursal
@sucursal_id int,
@prod_codinterno int
as
...
Producto.prod_nrocat as 'nrocat'
          FROM         dbo.Producto INNER JOIN
               ...
               where Sucursal.sucursal_id = @sucursal_id and Producto.prod_codinterno = @prod_codinterno 
               and
...
----5) voy a traer todos los lotes de un producto de una sucursal.
...
where Producto_x_sucursal.sucursal_id = @sucursal_id and Producto.prod_codinterno =@prod_codinterno and dbo.Producto_x_sucursal_lote.lote_cantidad> 0 
