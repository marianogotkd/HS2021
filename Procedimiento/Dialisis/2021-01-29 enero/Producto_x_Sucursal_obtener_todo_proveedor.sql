USE [Dialisis]
GO
/****** Object:  StoredProcedure [dbo].[Producto_x_Sucursal_obtener_todo_proveedor]    Script Date: 01/29/2021 15:33:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER procedure [dbo].[Producto_x_Sucursal_obtener_todo_proveedor]
...
FROM         dbo.Producto INNER JOIN
               ...
               where Sucursal.sucursal_id = @sucursal_id and ProveedorProducto.Prov_id = @Prov_id 
