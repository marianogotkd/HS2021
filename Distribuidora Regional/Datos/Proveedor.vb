...
Public Class Proveedor
    ...
    'proveedor alta
    Public Sub Proveedor_Alta(ByVal Prov_codigo As String, ByVal Prov_nombre As String, ByVal Prov_responsable As String, ByVal Prov_direccion As String, ByVal Prov_telefono As String, ByVal Prov_celular As String, ByVal Prov_mail As String, ByVal Prov_Observaciones As String)
        Try
            dbconn.Open()
    ...
    'proveedor modificar
    Public Sub Proveedor_modificar(ByVal Prov_codigo As String, ByVal Prov_nombre As String, ByVal Prov_responsable As String, ByVal Prov_direccion As String, ByVal Prov_telefono As String,
    ...
    'Proveedor_buscar
    Public Function Proveedor_buscar(ByVal Prov_codigo As String, ByVal Prov_nombre As String) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try
    ...
    Public Function Proveedor_obtenerDatos(ByVal Prov_codigo As String, ByVal Prov_nombre As String) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try
