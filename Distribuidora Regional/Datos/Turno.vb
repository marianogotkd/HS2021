...
Public Class Turno
    ...
    Public Function TurnoConfiguracion_obtener(ByVal TURNO_CONF_fecha As Date, ByVal CANCHA_T_id As String) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try
    ...
    Public Function TurnoReservado_Obtener(ByVal FECHA As Date, ByVal CANCHA_id As String, ByVal TURNO_CONF_desde As String,
        ...
        Dim comando As New OleDbCommand("TurnoReservado_Obtener", dbconn)
        comando.CommandType = CommandType.StoredProcedure
    ...
    Public Sub VentaTurnoReservado_Alta(ByVal TURNO_id As String, ByVal TURNO_T_id As String, ByVal VENTA_TURNO_fecha As Date, ByVal VENTA_TURNO_costo As String,
