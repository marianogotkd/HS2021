...
Public Class CR_InformeCliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.CR_InformeCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_InformeCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_InformeCliente = New CR_InformeCliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
