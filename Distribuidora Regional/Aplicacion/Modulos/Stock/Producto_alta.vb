            ...
            If result = DialogResult.OK Then
                ...
                If valido_producto.Tables(0).Rows.Count = 0 Then
                    ...
                    For Each row As DataGridViewRow In DG_Prov_Prod.Rows
                        ...
                        DAproducto.ProveedorProductoCompra_alta(provprodid, row.Cells("ProvProdComfechaDataGridViewTextBoxColumn").Value, row.Cells("ProvProdComprecioDataGridViewTextBoxColumn").Value)
                    Next
