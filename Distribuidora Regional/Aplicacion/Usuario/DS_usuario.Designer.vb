...
Partial Public Class DS_usuario
    ...
    Partial Public Class UsuariosDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddUsuariosRow(ByVal USU_id As String, ByVal USU_ape As String, ByVal USU_nom As String, ByVal UT_desc As String) As UsuariosRow
            Dim rowUsuariosRow As UsuariosRow = CType(Me.NewRow,UsuariosRow)
            Dim columnValuesArray() As Object = New Object() {USU_id, USU_ape, USU_nom, UT_desc}
