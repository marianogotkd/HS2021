...
Public Class CR_Informe_retiro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.CR_Informe_retiro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Informe_retiro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Informe_retiro = New CR_Informe_retiro()
        rpt.Site = Me.Site
        Return rpt
    End Function
