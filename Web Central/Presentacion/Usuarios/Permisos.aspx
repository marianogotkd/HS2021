<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Permisos.aspx.vb" Inherits="Presentacion.Permisos" %>
...
<div class="card card-primary">
              ...
              <div class="row">
                 ...
                 <asp:DropDownList ID="DropDown_Usuario" runat="server"  CssClass="form-control" 
                                 AutoPostBack="True">
                  </asp:DropDownList>
                      </div>
                        ...
                        <div class="form-group">                                    
                  <br />
                  <asp:Button ID="_btn_AgrUsuario" CssClass="btn btn-primary" runat="server" Text="Agregar" 
                              Font-Size="Large" />        
                  </div>
                 ...
                 <asp:DropDownList ID="DropDownList_Rol" runat="server"  CssClass="form-control" 
                           ...
                           <div class="card card-primary" visible="false" runat="server" id="div_titulo">
                     <div class="card-header">
                <h3 class="card-title">Roles Para 
                    <asp:Label ID="lbl_nom" runat="server" Text="Label"></asp:Label> </h3>
              </div>
               </div>
              ...
              <div class="card-body">
                  ...
                  <asp:GridView ID="GridView1" runat="server" 
                      ...
                      <Columns>
                          <asp:BoundField DataField="RolId" HeaderText="Codigo" />
                          <asp:BoundField DataField="RolDesc" HeaderText="Roles" />
