<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="Grupos_alta_a.aspx.vb" Inherits="Presentacion.Grupos_alta_a_aspx" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" 
    ...
    <div class="form-group">
            <div class="row justify-content-center">
                    ...
                    <div class="col-md-6">
                    <label for="Label_importe_fecha">Importe a la fecha:</label>
