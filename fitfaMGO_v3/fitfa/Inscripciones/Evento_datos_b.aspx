<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MasterPage.Master" CodeBehind="Evento_datos_b.aspx.vb" Inherits="fitfa.Evento_datos_b" %>
...
<div class="card card-primary">
                    ...
                    <table class="w-100">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txt_peso" ValidChars="0123456789.">
                                </asp:FilteredTextBoxExtender>
              ...
              <button type="submit" class="btn btn-primary" runat="server" id="Btn_confirmar_submit2">Confirmar submit 2</button>
