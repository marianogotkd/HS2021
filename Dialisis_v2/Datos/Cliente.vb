...
Public Class Cliente
    ...
    'Cliente_Alta_new
    Public Function Cliente_Alta_new(ByVal CLI_ape As String,
                                ...
                                ByVal CLI_fnac As Date,
                                ByVal CLI_sexo As String,
                                ByVal CLI_obsoc As String,
                                ByVal CLI_numafi As String) As DataSet
        Try
            dbconn.Open()
        ...
        comando.Parameters.Add(New OleDb.OleDbParameter("@CLI_sexo", CLI_sexo))
        comando.Parameters.Add(New OleDb.OleDbParameter("@CLI_obsoc", CLI_obsoc))
        comando.Parameters.Add(New OleDb.OleDbParameter("@CLI_numafi", CLI_numafi))
