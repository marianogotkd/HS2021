...
Public Class CuentaCorriente
    ...
    Public Function CtaCte_movimiento_modificar(ByVal movimiento_id As Integer, ByVal MovimientosCtaCte_concepto As String) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try
    ...
    Public Function Recibo_alta(ByVal mov_id As Integer, ByVal fecha As DateTime)
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try
