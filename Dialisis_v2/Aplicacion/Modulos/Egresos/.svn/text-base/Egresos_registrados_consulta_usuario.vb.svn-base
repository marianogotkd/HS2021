Public Class Egresos_registrados_consulta_usuario
    Dim DAEgresos As New Datos.Egresos
    Dim DAUsuario As New Datos.Usuario
    Dim dataset_egresos As DataSet

    Private Sub Egresos_registrados_consulta_usuario_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        obtener_egresos()
        obtener_usuarios()
        tabla_filtrada()
