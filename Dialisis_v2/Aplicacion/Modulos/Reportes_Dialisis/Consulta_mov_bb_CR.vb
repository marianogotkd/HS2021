...
Public Class Consulta_mov_bb_CR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.Consulta_mov_bb_CR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsulta_mov_bb_CR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Consulta_mov_bb_CR = New Consulta_mov_bb_CR()
        rpt.Site = Me.Site
        Return rpt
    End Function
