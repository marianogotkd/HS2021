...
Public Class Consulta_baja_b_CR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.Consulta_baja_b_CR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsulta_baja_b_CR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Consulta_baja_b_CR = New Consulta_baja_b_CR()
        rpt.Site = Me.Site
        Return rpt
    End Function
