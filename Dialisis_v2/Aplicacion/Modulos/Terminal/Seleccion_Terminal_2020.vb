...
Public Class Seleccion_Terminal_2020
...
#End Region
    ...
    Private Sub Seleccion_Terminal_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        'si cierro el form vuelvo a el modulo seleccion_menu
    ...
    Private Sub Seleccion_Terminal_2020_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Button_siguiente.Focus()
        Dim suc_id As String
        suc_id = Seleccion_menu.suc_id  'obtengo del formulario inicio el id del usuario logueado
    ...
    Private Sub Button_siguiente_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button_siguiente.Click
        var = "siguiente"
        Dim ds As DataSet = DAterminal.Usuario_x_Terminal_Validar(Seleccion_menu.USU_id, ComboBox_Terminales.SelectedValue)

        If ds.Tables(0).Rows.Count = 0 Then
            DAterminal.Usuario_x_Terminal_Registrar(Seleccion_menu.USU_id, ComboBox_Terminales.SelectedValue)
            Seleccion_menu.terminal_id = ComboBox_Terminales.SelectedValue
            'US_administrador.Lbl_Terminal.Text = ComboBox_Terminales.Text
            Menu_2020.Label_Suc.Text = Menu_2020.Label_Suc.Text.ToUpper + ", TERMINAL: " + ComboBox_Terminales.Text.ToUpper
            'US_administrador.Lbl_Terminal.Visible = True
            'Menu_2020.Lbl_Terminal.Visible = True
        ...
        Else
            If Seleccion_menu.UT_id = 1 Then 'si es admin, ingreso siempre
                'entro
                Seleccion_menu.terminal_id = ComboBox_Terminales.SelectedValue
                'US_administrador.Lbl_Terminal.Text = ComboBox_Terminales.Text
                Menu_2020.Label_Suc.Text = Menu_2020.Label_Suc.Text.ToUpper + ", TERMINAL: " + ComboBox_Terminales.Text.ToUpper
            ...
            Else 'si no es admin, que valide el acceso a la terminal
                If ds.Tables(0).Rows(0).Item("USU_id") = Seleccion_menu.USU_id Then
                    'entro
                    Seleccion_menu.terminal_id = ComboBox_Terminales.SelectedValue
                    'US_administrador.Lbl_Terminal.Text = ComboBox_Terminales.Text
                    Menu_2020.Label_Suc.Text = Menu_2020.Label_Suc.Text.ToUpper + ", TERMINAL: " + ComboBox_Terminales.Text.ToUpper
