    ...
    Private Sub Cargar_Perfil()
        If paso = "si" Then
            ...
            While i < DS_Modulos.Tables(0).Rows.Count
                ...
                If DS_Modulos.Tables(0).Rows(i).Item("USUModulos_descripcion") = "Cliente_Medico" Then
                    CheckBox_cli_Actualizar.Checked = True
                Else
                End If
                '___Fin CLiente____
...
#Region "Checkboxes"
    ...
    Private Sub chk_medico_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chk_medico.CheckedChanged
        If CheckBox_Cli_todos.Checked = True And chk_medico.Checked = False Then
            CheckBox_Cli_todos.Checked = False
        End If
    End Sub
        ...
        Else
            ...
            If result = DialogResult.Yes Then
                ...
                If CheckBox_Cli_todos.Checked = True Then
                    ...
                    dausuario.UsuarioModulos_alta(cb_tipous.SelectedValue, "Cliente_Medico")
                    guardado = 1
                Else
                    ...
                    If chk_medico.Checked = True Then
                        dausuario.UsuarioModulos_alta(cb_tipous.SelectedValue, "Cliente_Medico")
                        guardado = 1
                    End If
