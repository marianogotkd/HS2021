...
Public Class CR_InformeEmpleDP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.CR_InformeEmpleDP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_InformeEmpleDP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_InformeEmpleDP = New CR_InformeEmpleDP()
        rpt.Site = Me.Site
        Return rpt
    End Function
