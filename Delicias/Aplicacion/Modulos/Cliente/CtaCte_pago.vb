    ...
    Private Sub registrar_efectivo()
        ...
        Else
            ...
            If ds_cuentacorrente.Tables(0).Rows.Count <> 0 Then
                ...
                Dim concepto As String = "Pago Efectivo, Recibo Nº:"
                ...
                Dim ds_recibo As DataSet = DAcuentacorriente.Recibo_alta(movimiento_id, Now)
                Dim recibo_id As Integer = ds_recibo.Tables(0).Rows(0).Item("recibo_id")
                ...
                '   nro_recibo = 1
                'End If
                concepto = "Pago Efectivo, Recibo Nº:" + CStr(recibo_id)
                DAcuentacorriente.CtaCte_movimiento_modificar(movimiento_id, concepto)
                ...
                crear_reporte(ds_usuario, recibo_id)
        ...
        Else
            If tx_tarjeta.Text <> "" And tx_comprobante.Text <> "" Then
                ...
                If ds_cuentacorrente.Tables(0).Rows.Count <> 0 Then
                    ...
                    '    nro_recibo = 1
                    'End If
                    Dim concepto As String = "Pago Tarjeta, Recibo Nº:" + ", Tarjeta:" + tx_tarjeta.Text + ", Comprobante:" + tx_comprobante.Text
                    Dim ds_mov As DataSet = DAcuentacorriente.CtaCte_movimiento_alta(CtaCte_id, "Egreso", concepto, CDec(tx_total.Text), Now)
                    'ahora falta el alta en la tabla recibo
                    Dim movimiento_id As Integer = ds_mov.Tables(0).Rows(0).Item("MovimientosCtaCte_id")
                    Dim ds_recibo As DataSet = DAcuentacorriente.Recibo_alta(movimiento_id, Now)
                    ...
                    concepto = "Pago Tarjeta, Recibo Nº:" + CStr(recibo_id) + ", Tarjeta:" + tx_tarjeta.Text + ", Comprobante:" + tx_comprobante.Text
                    DAcuentacorriente.CtaCte_movimiento_modificar(movimiento_id, concepto)
