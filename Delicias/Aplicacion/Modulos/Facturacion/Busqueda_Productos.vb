            ...
            Case "Minorista"
                ...
                While i < Venta_Caja_gestion.VentaGestion_DS_PROD.Tables(1).Rows.Count 'la tabla 1 es para los prod comunes, no para los de la lista regular
                    ...
                    If cod_ingresado = cod_interno Or CStr(cod_ingresado) = cod_barra Then
                        ...
                        Venta_Caja_gestion.tipo_prod = Venta_Caja_gestion.VentaGestion_DS_PROD.Tables(1).Rows(i).Item("prod_tipo").ToString
                        Venta_Caja_gestion.precio_editable = Venta_Caja_gestion.VentaGestion_DS_PROD.Tables(1).Rows(i).Item("prod_precio_editable").ToString
