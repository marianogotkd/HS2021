...
Public Class Producto
    ...
    Public Function Producto_Alta_New(ByVal prod_descripcion As String, ByVal prod_descrilarga As String, ByVal prod_precio_vta As Decimal, ByVal prod_stock As Integer, ByVal prod_ptorepo As String, ByVal prod_codinterno As String,
                                  ByVal prod_codbarra As String, ByVal idcat As Integer, ByVal nrocat As Integer, ByVal idmarca As Integer, ByVal prod_unimedida As String, ByVal producto_foto() As Byte, ByVal prod_precio_vta_May As Decimal, ByVal prod_tipo As String, ByVal prod_precio_editable As String) As DataSet
        Try
            dbconn.Open()
        ...
        comando.Parameters.Add(New OleDb.OleDbParameter("@prod_precio_editable", prod_precio_editable))
    ...
    Public Function Producto_modificar(ByVal prod_descripcion As String,
                                ...
                                ByVal prod_precio_editable As String) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try
