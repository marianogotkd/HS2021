...
Public Class Conexion
    ...
    ''local sin seguridad
    Public dbconn As New OleDb.OleDbConnection("Provider=SQLOLEDB.1;Persist Security Info=False;User ID=choco; password=123choco;Initial Catalog=fitfaBD;Data Source=(local)")
    ...
    'Conexion web Donweb
    'Public dbconn As New OleDb.OleDbConnection("Provider=SQLNCLI10;Server=localhost;Database=wi181976_fitfabd; Trusted_Connection=yes")
