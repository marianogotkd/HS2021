<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MasterPage.Master" CodeBehind="Miembros.aspx.vb" Inherits="fitfa.Miembros" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card card-primary">
              ...
              <div> &nbsp;&nbsp; 
                  <asp:Label ID="Label11" runat="server" Font-Bold="True" Text="Alumnos de: " 
                  ...
                  <asp:DropDownList ID="DropDownList_instructores" runat="server" 
                      AutoPostBack="True" Font-Bold="True" ForeColor="Blue" Font-Size="Small">
                  </asp:DropDownList>
              ...
              <div>
                  &nbsp;&nbsp;&nbsp;<asp:Label ID="Label38" runat="server" Font-Bold="True" Font-Size="Small" 
                      Text="Cantidad de Alumnos directos:"></asp:Label>
                  &nbsp;<asp:Label ID="lb_cant_alumnos" runat="server" Font-Bold="True" 
                      Font-Size="Small" Text="0" ForeColor="#009933"></asp:Label>
              </div>

              <div>
                  &nbsp;&nbsp;&nbsp;<asp:Label ID="Label40" runat="server" Font-Bold="True" Font-Size="Small" 
                      Text="Cantidad de miembros:"></asp:Label>
                  &nbsp;<asp:Label ID="lb_cant_miembros" runat="server" Font-Bold="True" 
                      Font-Size="Small" Text="0" ForeColor="#009933"></asp:Label>
              </div>
...
--%>
    ...
    <%--aqui va el cartel de carga progress...fuera del panel principal--%>
